...
<head>
    <meta charset="UTF-8">
    <title>Editar Información de Contacto</title>
...
<div class="container mt-5">
    ...
    <form action="{{ route('informacion_contacto.update', $data->id_contact_information) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="type_contact" class="form-control" value="{{ old('type_contact', $data->type_contact) }}" required>
        </div>

        <div class="mb-3">
            <label for="data_contact" class="form-label">Dato de Contacto</label>
            <input type="text" name="data_contact" class="form-control" value="{{ old('data_contact', $data->data_contact) }}" required>
        </div>
