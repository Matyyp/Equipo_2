...
<nav class="bg-gray-900 text-white px-6 py-4 relative z-50">
    <div class="flex justify-between items-center">
        ...
        <ul id="menu" class="hidden md:flex gap-8 items-center absolute md:static top-16 left-0 w-full md:w-auto bg-gray-900 md:bg-transparent md:flex-row flex-col z-40 md:z-auto">
            ...
            <li class="md:hidden flex gap-2 mt-2 px-4">
                <a href="#" class="bg-white text-black px-4 py-1 rounded hover:bg-orange-400">Únetenos</a>
                <a href="#" class="bg-orange-500 px-4 py-1 rounded hover:bg-orange-600">Iniciar sesión</a>
            </li>
        </ul>
